      ...
      const generatedInsights: AIInsight[] = [
        {
          ...
          description:
            'Your mood tends to dip on Mondays and improve throughout the week. Consider implementing a Sunday evening routine to prepare for Monday.',
          confidence: 87,
          priority: 'medium',
          actionable: true,
        ...
        },
        {
          ...
          description:
            'Days when you meditate show 23% higher mood scores. Your optimal meditation time appears to be 15-20 minutes in the morning.',
          confidence: 92,
          priority: 'high',
          actionable: true,
        ...
        },
        {
          ...
          description:
            'Your average stress levels have decreased by 18% over the past month. Keep up the great work with your current strategies!',
          confidence: 95,
          priority: 'low',
          actionable: false,
          category: 'Progress',
        ...
        },
        {
          ...
          description:
            'Your sleep quality has been declining for 5 consecutive days. Poor sleep is strongly correlated with lower mood scores in your data.',
          confidence: 84,
          priority: 'high',
          actionable: true,
        ...
        },
        {
          ...
          description:
            "Based on your patterns, you're likely to experience improved mood this weekend. Perfect time for social activities or outdoor exercise.",
          confidence: 76,
          priority: 'medium',
          actionable: true,
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Personalized mental health analytics powered by artificial
            intelligence
          </p>
        </div>
        ...
        <TabsContent value="patterns" className="space-y-6">
          <div className="grid md:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Your overall wellness across different dimensions
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Detected patterns in your mental health data
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
        ...
        <TabsContent value="predictions" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                AI predictions for your upcoming mental health trends
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {insights
                  ...
                  .map((insight) => (
                    <div
                      key={insight.id}
                      className="flex items-start space-x-4 p-4 rounded-lg border bg-purple-50"
                    >
                      <div
                        className={`p-2 rounded-lg ${getInsightColor(
                          insight.type
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center space-x-4 mt-3">
                          ...
                          <span className="text-xs text-gray-500">
                            Based on {Math.floor(Math.random() * 30) + 30} days
                            of data
                          </span>
                        </div>
                      </div>
        ...
        <TabsContent value="correlations" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                How different activities and factors affect your mood
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
