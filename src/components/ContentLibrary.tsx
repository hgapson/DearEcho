  ...
  const mockCourses: Course[] = [
    {
      ...
      description:
        'Learn the fundamentals of mindfulness meditation and how to integrate it into your daily life.',
      ...
      modules: [
        ...
        },
        {
          ...
          description:
            'Learn fundamental breathing exercises for calm and focus',
          duration: 60,
    ...
    },
    {
      ...
      description:
        'Understand CBT principles and learn practical techniques for managing thoughts and emotions.',
    ...
    },
    {
      ...
      description:
        'Comprehensive guide to improving sleep quality and establishing healthy sleep patterns.',
      ...
      isPremium: false,
      thumbnail:
        'https://images.unsplash.com/photo-1541781774459-bb2af2f05b55?w=400&h=225&fit=crop',
  ...
  const mockArticles: Article[] = [
    {
      ...
      excerpt:
        'A comprehensive guide to recognizing anxiety disorders and evidence-based treatment approaches.',
      ...
      isPremium: false,
      thumbnail:
        'https://images.unsplash.com/photo-1559757174-f716246fbb21?w=400&h=225&fit=crop',
      isBookmarked: true,
    },
    {
      id: '2',
      ...
      excerpt:
        'Research-backed insights into how practicing gratitude can transform your mental health.',
    ...
    },
    {
      ...
      excerpt:
        'Practical strategies for developing emotional resilience and adapting to life transitions.',
      ...
      isPremium: false,
      thumbnail:
        'https://images.unsplash.com/photo-1494059980473-813e73ee784b?w=400&h=225&fit=crop',
      isBookmarked: false,
    },
  ]
  ...
  const mockAudioContent: AudioContent[] = [
    {
      ...
      description:
        'Start your day with clarity and focus through this guided meditation session.',
    ...
    },
    {
      ...
      description:
        'Drift off to peaceful sleep with calming ocean sounds and gentle narration.',
    ...
    },
    {
      ...
      description:
        'Expert discussion on managing workplace stress and maintaining work-life balance.',
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-2">
            Comprehensive mental health education and resources
          </p>
        </div>
