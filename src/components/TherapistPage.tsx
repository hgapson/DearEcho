...
export function TherapistPage({
    ...
    therapists.length === 0
      ? [
          ...
          },
          {
            ...
            experience: 12,
            education: [
              'MS in Marriage & Family Therapy - USC',
          ...
          },
          {
            ...
            avatar:
              'https://images.unsplash.com/photo-1594824895013-df6b9a5e6053?w=400&h=400&fit=crop&crop=face',
            ...
            experience: 6,
            education: [
              'MS in Clinical Mental Health Counseling - NYU',
              'BA in Social Work - Columbia',
            ],
  ...
  const handleAppointmentRequest = () => {
    ...
    toast.success(
      `Appointment requested with ${selectedTherapist.name}! They will contact you soon.`
    )
  ...
  const handleTherapistSubmit = () => {
    ...
    toast.success(
      "Therapist registration submitted! We'll review your application and contact you soon."
    )
    setViewMode('browse')
    ...
    return (
      <div className="min-h-screen pt-6 pb-20 px-4 bg-gradient-to-br from-blue-50/30 via-purple-50/20 to-pink-50/30">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Find licensed mental health professionals who can support your
        ...
        {selectedTherapist && (
          ...
          >
            <Card
              className="max-w-2xl w-full max-h-[80vh] overflow-y-auto bg-white shadow-2xl"
              ...
              <CardContent className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-medium text-green-600">
                      ${selectedTherapist.hourlyRate}/session
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    {selectedDate &&
                      getAvailableTimeSlots(selectedTherapist, selectedDate)
                        .length === 0 && (
      ...
      <div className="min-h-screen pt-6 pb-20 px-4 bg-gradient-to-br from-blue-50/30 via-purple-50/20 to-pink-50/30">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Help others on their mental wellness journey. Apply to become a
              verified therapist on DearEcho.
            </p>
          </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Select onValueChange={addSpecialty}>
                      ...
                      <SelectContent>
                        {specialties
                          .filter((s) => !therapistForm.specialties.includes(s))
                          .map((specialty) => (
                            <SelectItem key={specialty} value={specialty}>
                              {specialty}
                            </SelectItem>
