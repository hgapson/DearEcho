...
export function CommunityHub({ user, posts, supportGroups, onCreatePost }: CommunityHubProps) {
  const [activeTab, setActiveTab] = useState('feed');
  const [searchQuery, setSearchQuery] = useState('');
  const [newPostContent, setNewPostContent] = useState('');
  const [newPostType, setNewPostType] = useState<'text' | 'question' | 'milestone'>('text');
  ...
  const mockPosts: CommunityPost[] = [
    {
      ...
      userId: 'user1',
      userName: 'Sarah M.',
      userAvatar: 'https://images.unsplash.com/photo-1494790108755-2616b612b212?w=100&h=100&fit=crop&crop=face',
      content: "Just completed my 30-day meditation streak! 🧘‍♀️ The journey wasn't easy, but I've noticed such a positive change in my daily stress levels. For anyone starting out, remember that even 5 minutes counts!",
      type: 'milestone',
      ...
      comments: [
        {
          ...
          userId: 'user2',
          userName: 'Alex K.',
          content: 'Congratulations! That\'s amazing progress. What meditation style did you find most helpful?',
    ...
    },
    {
      ...
      userId: 'user3',
      userName: 'Anonymous',
      content: "I've been struggling with anxiety lately, especially in social situations. Does anyone have tips for managing social anxiety? I'd really appreciate any advice from those who've been through similar experiences.",
      type: 'question',
      ...
      comments: [
        {
          ...
          content: 'Breathing exercises can be very helpful. Try the 4-7-8 technique: breathe in for 4, hold for 7, exhale for 8. Also, remember that most people are focused on themselves, not judging you.',
  ...
  const mockGroups: SupportGroup[] = [
    {
      ...
      topics: ['Coping Strategies', 'Daily Check-ins', 'Success Stories', 'Resources'],
      meetingSchedule: 'Tuesdays & Thursdays 7:00 PM EST'
    },
    {
      id: '2',
      name: 'Mindfulness & Meditation',
      description: 'Share your meditation journey, techniques, and find accountability partners for daily practice.',
    ...
    },
    {
      ...
      description: 'Peer support specifically for adults aged 18-30 navigating mental health challenges.',
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-center space-x-3">
                        <Avatar className="w-10 h-10">
                          ...
                          <AvatarFallback>
                            {post.isAnonymous ? 'A' : post.userName.split(' ').map(n => n[0]).join('')}
                          </AvatarFallback>
                        </Avatar>
                        <div>
                          ...
                          <p className="text-sm text-gray-500">
                            ...
                            {post.supportGroup && ` in ${mockGroups.find(g => g.id === post.supportGroup)?.name || 'Group'}`}
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-3">
                    {['mindfulness', 'anxiety-support', 'self-care', 'meditation', 'therapy'].map((topic, index) => (
              ...
              <Card key={group.id} className="hover:shadow-lg transition-shadow cursor-pointer">
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <Button className="w-full mt-4" variant={group.isPrivate ? "outline" : "default"}>
            ...
            {[
              {
                ...
                description: 'Join our guided group meditation and mindfulness practice',
                date: '2024-01-20',
                time: '7:00 PM EST',
                type: 'Virtual',
                attendees: 45
              },
              {
                ...
                description: 'Safe space discussion group for anxiety management',
                date: '2024-01-22',
                time: '6:30 PM EST',
                type: 'Virtual',
                attendees: 23
              },
              {
                ...
                description: 'Learn how to provide initial support for mental health crises',
                date: '2024-01-25',
                time: '2:00 PM EST',
                type: 'Hybrid',
                attendees: 67
            ...
            {[
              {
                ...
                description: 'Emergency contacts and immediate support resources',
                icon: Shield,
