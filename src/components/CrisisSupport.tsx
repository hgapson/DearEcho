...
import { AlertTriangle, Phone, MessageCircle, Heart, Shield, Clock, MapPin } from "lucide-react";
...
export function CrisisSupport({ user, onCrisisReport }: CrisisSupportProps) {
  ...
  const emergencyContacts = [
    ...
    { name: 'National Alliance on Mental Illness', number: '1-800-950-NAMI', available: '24/7' },
  ];
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <div className="text-center space-y-4 bg-red-50 p-6 rounded-lg border border-red-200">
        ...
        <p className="text-red-700 max-w-2xl mx-auto">
          If you're experiencing a mental health crisis or having thoughts of self-harm, please reach out for immediate help. You're not alone.
        </p>
        <div className="flex items-center justify-center space-x-4">
          ...
          <Button variant="outline" className="border-red-300 text-red-700" size="lg">
      ...
      <div className="grid md:grid-cols-2 gap-6">
              ...
              {emergencyContacts.map((contact, index) => (
                <div key={index} className="p-4 rounded-lg bg-blue-50 border border-blue-200">
                  <div className="flex items-start justify-between">
                    <div>
                      <h3 className="font-medium text-blue-900">{contact.name}</h3>
                      <p className="text-blue-700 font-mono text-lg">{contact.number}</p>
                    </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Quick techniques to help right now</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Tools to help you prepare for future crises</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      {user && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Help us understand community needs (completely confidential)</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <p className="text-xs text-gray-500">All reports are anonymous and help improve our support resources</p>
                <Button onClick={handleCrisisReport}>
                  Submit Report
                </Button>
              </div>
            </div>
