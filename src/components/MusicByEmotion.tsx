...
export function MusicByEmotion({ user }: MusicByEmotionProps) {
  ...
  const currentPlaylist = playlists[selectedMood as keyof typeof playlists] || playlists.calm;
    ...
    <div className="min-h-screen pt-6 pb-20 px-4 bg-gradient-to-br from-blue-50/30 via-purple-50/20 to-pink-50/30">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Music for Your Mood</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Let music be your companion in healing. Choose your current mood and discover curated songs to support your emotional journey.
          </p>
        </div>
        ...
        {selectedMoodInfo && (
          <Card className={`shadow-xl border-0 bg-white/70 backdrop-blur-sm mb-8 ${selectedMoodInfo.bgColor} border-l-4 border-l-current`}>
            <CardHeader>
              <div className="flex items-center space-x-3">
                <div className={`inline-flex items-center justify-center w-12 h-12 bg-gradient-to-br ${selectedMoodInfo.color} rounded-full shadow-lg`}>
                ...
                <div>
                  ...
                  <p className="text-gray-600">Curated songs to match your current mood</p>
                </div>
              </div>
            </CardHeader>
            <CardContent>
                ...
                {currentPlaylist.map((song, index) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <h4 className="text-base font-semibold text-gray-800 truncate">{song.title}</h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-800">Reduces Stress</h4>
                    <p className="text-sm text-gray-600">Listening to music can lower cortisol levels and reduce anxiety.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-800">Improves Mood</h4>
                    <p className="text-sm text-gray-600">Music releases dopamine, creating feelings of pleasure and happiness.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-800">Enhances Focus</h4>
                    <p className="text-sm text-gray-600">Certain music can improve concentration and cognitive performance.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-800">Supports Sleep</h4>
                    <p className="text-sm text-gray-600">Calming music can help regulate sleep patterns and improve rest quality.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Music helps us process and express complex emotions safely.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Shared musical experiences create bonds and reduce feelings of isolation.</p>
                  </div>
                </div>
              </div>
            </div>
