...
export function NavigationMenu({ 
  ...
  const navItems = [
    { id: 'welcome' as AppPage, icon: Home, label: 'Home', requiresAuth: false },
    { id: 'mood' as AppPage, icon: Heart, label: 'Mood', requiresAuth: true },
    { id: 'letter' as AppPage, icon: PenTool, label: 'Letter', requiresAuth: true },
    { id: 'journal' as AppPage, icon: BookOpen, label: 'Journal', requiresAuth: true },
    { id: 'draw' as AppPage, icon: Palette, label: 'Draw', requiresAuth: false },
  ];

  const secondaryItems = [
    { id: 'music' as AppPage, icon: Music, label: 'Music', requiresAuth: false },
    { id: 'quotes' as AppPage, icon: Quote, label: 'Quotes', requiresAuth: false },
    { id: 'gallery' as AppPage, icon: Image, label: 'Gallery', requiresAuth: true },
    { id: 'analytics' as AppPage, icon: BarChart3, label: 'Analytics', requiresAuth: true },
    { id: 'therapist' as AppPage, icon: UserCircle, label: 'Therapy', requiresAuth: false },
  ];
                  ...
                  {secondaryItems.map((item) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {isDisabled && <div className="ml-auto w-2 h-2 bg-yellow-500 rounded-full"></div>}
                      </DropdownMenuItem>
                    );
                  })}
                  <DropdownMenuSeparator />
