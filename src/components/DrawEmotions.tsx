...
export function DrawEmotions({ user, onSaveDrawing }: DrawEmotionsProps) {
  ...
  const moods = [
    ...
    { id: "creative", label: "Creative", color: "bg-purple-100 text-purple-700" },
    ...
    <div className="min-h-screen pt-6 pb-20 px-4 bg-gradient-to-br from-blue-50/30 via-purple-50/20 to-pink-50/30">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Express Through Art</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Let your emotions flow through colors and shapes. Art can be a powerful way to process feelings.
          </p>
        </div>
